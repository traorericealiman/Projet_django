...
def index(request):
    ...
    return render(request, 'produits/index.html', {'produits': product_object, 'categories':categories, 'number': number})
...
def confidentialité(request):
    return render(request, 'produits/confidentialité.html')

def About(request):
    return render(request, 'produits/About.html')
